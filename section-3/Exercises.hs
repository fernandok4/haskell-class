module Exercises where
    ...
    converteEscala :: Double -> Temperatura -> Temperatura -> Double
    converteEscala graus deTemp paraTemp = ((graus - minDeTemp) * (maxParaTemp - minParaTemp) / (maxDeTemp - minDeTemp)) + minParaTemp
